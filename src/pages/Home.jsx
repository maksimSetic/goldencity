  ...
  const investmentSteps = [
    {
      ...
      description:
        "Connect your cryptocurrency wallet to GoldenCity to start investing.",
    },
    {
      icon: FaStore,
      ...
      <section className="container">
        <div className="bg-primary-600 rounded-2xl p-8 md:p-12 text-white text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Link
              to="/properties"
              className="btn w-full flex items-center justify-center sm:w-auto bg-white text-primary-600 hover:bg-primary-50"
            >
              Browse Properties
            </Link>
            <ConnectWallet
              buttonClass="btn w-full flex items-center justify-center sm:w-auto"
              buttonChildren={
                <>
